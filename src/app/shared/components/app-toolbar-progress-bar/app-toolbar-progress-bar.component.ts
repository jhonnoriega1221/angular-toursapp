...
@Component({
  selector: 'app-toolbar-progress-bar',
  templateUrl: './app-toolbar-progress-bar.component.html',
  styleUrls: ['./app-toolbar-progress-bar.component.scss'],
    animations: [
...
export class AppToolbarProgressBarComponent implements OnInit {
